...
const AdminCases = ({dateStart,dateEnd,handleDateStartChange,handleDateEndChange,getData,reset}) => {
  ...
  return (
    ...
    <div className="inputs mt-5">
            ...
            <div className="detail-btn mt-10 flex flex-1 justify-center gap-7">
